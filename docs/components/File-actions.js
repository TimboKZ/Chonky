...
export default class FileActionsComponent extends React.Component {
    ...
    handleSingleClick = (file, event) => {
        this.setState(prevState => ({singleClickCount: prevState.singleClickCount + 1}));
    ...
    handleDoubleClick = (file, event) => {
        this.setState(prevState => ({doubleClickCount: prevState.doubleClickCount + 1}));
