...
import {generateTestFiles, simulateEntryClick, simulateEntryKeypress} from './TestUtil';
...
test('Single click and space triggers single click handler', async () => {
    ...
    const fileBrowser = mount<FileBrowser>(<FileBrowser files={demoFiles} onFileSingleClick={clickSpy}/>);
